    ...
    return (
        // <BrowserRouter>
            <div className=" flex  justify-between md:justify-normal md:gap-x-12  bg-transparent items-center px-4" style={{boxShadow: "rgba(0, 0, 0, 0.1) 0px 20px 25px -5px, rgba(0, 0, 0, 0.04) 0px 10px 10px -5px " }}>
                {/* <div className=" md:mt-[-12px] rounded-full flex mt-4 border border-black aspect-square"> */}
                <div className="w-1/6">
                    <Link to="/home"> 
                ...
                <nav className="rounded-md  p-2 md:h-1/4 lg:h-12 text-xl w-5/6 justify-evenly items-center hidden md:flex md:sticky " id="desktop-view">
                    <Link to="/home">
