...
export default function Person_or_Agent() {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center text-center  text-balance justify-around border z-100  border-black h-screen bg-gray-100 bg-[url('./src/assets/background.jpg')]">
