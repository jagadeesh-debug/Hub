...
export default function Home() {
    return (
        <div className="flex flex-col max-h-screen md:flex-row justify-between mt-12 md:mt-32">
            ...
            <div className="md:w-1/2 border border-black rounded-md mt-2 flex justify-center items-center bg-gray-300 h-1/2 md:h-auto">
