    ...
    return (
        <div className="h-screen max-w-screen flex flex-col  ">
            <div className="flex flex-col items-center justify-center w-full ">
                <h2 className="text-green-600 text-center text-xl md:w-1/2 md:text-3xl px-2 py-2 rounded-lg" style={{ fontFamily: 'Bagel Fat One, sans-serif', WebkitTextStroke: "black" }}>
                    Select Your City
                </h2>
                <select className="w-1/2 mt-2 border-none rounded-md cursor-pointer bg-transparent" style={{ fontFamily: 'Bagel Fat One, sans-serif' }}>
